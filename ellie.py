...
p = subprocess.Popen(['python3', 'ExportElliePIN.py', os.path.join(os.getcwd(), project_path), 'search', str(args.positive_fdr), args.positives_output, args.unkown_output], cwd=tools_location, stderr=sys.stdout.fileno())        
assert(p.wait() == 0)
